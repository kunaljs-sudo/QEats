...
public interface RestaurantRepositoryService {
   ...
   * formula to find the distance between two lat/longs. - Ensure the restaurant is open currently.
   * 
  ...
  /**
   * Get the list of open restaurants within the specified serving radius which service item name in
   * search string.
   * 
